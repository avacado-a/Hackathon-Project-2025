...
def is_fist(hand_landmarks):
    """Checks if a hand is in a fist by checking if fingertips are below their respective PIP joints."""
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if not is_panning_now:
            if panning_state == "PANNING":  # Panning was just released
